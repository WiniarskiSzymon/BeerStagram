...
class BeerSearchAdapter(val items : List<BeerSearchResult>, val performAction: (beerID : Int)->  Unit) : RecyclerView.Adapter<BeerSearchAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: BeerSearchAdapter.ViewHolder, position: Int) {
        holder.apply {
            ...
            holder.view.setOnClickListener { performAction(items[position].beerId)}
