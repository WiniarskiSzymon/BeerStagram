...
//    val rule = InstantTaskExecutorRule()
    ...
    fun useAppContext() {
        ...
        val appContext = ApplicationProvider.getApplicationContext<BeerstagramApplication>()
        assertEquals("com.projects.bigswierku.beerstagram", appContext.packageName)
    }

    @Test
    fun clickSecondBarOption(){
        mockServer.enqueue(localCheckInsResponseMock)
        onView(withId(R.id.bottombaritem_images))
                .perform(click())
